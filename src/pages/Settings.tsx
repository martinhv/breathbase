      ...
      <section className="mb-6">
        ...
        <div className="rounded-2xl bg-white/5 border border-white/10 px-4 divide-y divide-white/5">
          ...
          {settings.voiceEnabled && voices.length > 0 && (
            <label className="flex items-center justify-between py-3 gap-3">
              ...
              <select
                ...
                className="bg-ink-700 border border-white/10 rounded-lg px-2 py-1 text-sm text-slate-200 max-w-[55%]"
              >
