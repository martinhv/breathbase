...
export function ReloadPrompt() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-ink-800/95 border border-white/10 shadow-xl backdrop-blur-sm">
        ...
        <button
          ...
          aria-label="Dismiss"
          className="px-2 py-1 rounded-lg text-slate-400 hover:bg-white/5"
        >
          ✕
        </button>
      </div>
