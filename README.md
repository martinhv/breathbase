...
- **Tone.js** for synthesized ambient pad + phase chimes
- **Pre-rendered MP3 voice prompts** (Microsoft Aria via edge-tts,
  generated by `scripts/generate-voice.sh` and cached by the service worker)
